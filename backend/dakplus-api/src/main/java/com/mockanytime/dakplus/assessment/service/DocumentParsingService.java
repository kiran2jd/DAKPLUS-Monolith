...
public class DocumentParsingService {
    ...
    public void cropImage(String fileName, java.util.List<Integer> bbox) {
        ...
        try {
            ...
            // Apply 15% padding to avoid cutting off edges (user reported edges still gone at 10%)
            ...
            System.out.println("SMART CROP: Successfully cropped " + fileName + " with 15% padding. Original box: " + bbox);
